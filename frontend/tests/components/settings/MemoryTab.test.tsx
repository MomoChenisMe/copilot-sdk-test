...
vi.mock('../../../src/lib/prompts-api', () => ({
  promptsApi: {
    ...
    getAutopilotPrompt: vi.fn().mockResolvedValue({ content: '' }),
    putAutopilotPrompt: vi.fn().mockResolvedValue({ ok: true }),
    resetAutopilotPrompt: vi.fn().mockResolvedValue({ content: '' }),
    getActPrompt: vi.fn().mockResolvedValue({ content: '' }),
    putActPrompt: vi.fn().mockResolvedValue({ ok: true }),
    resetActPrompt: vi.fn().mockResolvedValue({ content: '' }),
    getPlanPrompt: vi.fn().mockResolvedValue({ content: '' }),
    putPlanPrompt: vi.fn().mockResolvedValue({ ok: true }),
    resetPlanPrompt: vi.fn().mockResolvedValue({ content: '' }),
